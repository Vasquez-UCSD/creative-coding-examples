...
![Python](https://img.shields.io/badge/Concept-Systems%20%26%20Objects-purple)
![Python](https://img.shields.io/badge/Technique-Classes%20%26%20State-orange)
...
3. Open The_Interactive_Flora_Debugger.py
4. Click Run ▶
...
```
.
├── The_Interactive_Flora_Debugger.py
├── README.md
├──The_Interactive_Flora_Debugger/
│	├──The_Interactive_Flora_Debugger.pyde
│	└──The_Interactive_Flora_Debugger.properties
└── assets/
	└── ifss.png
```
