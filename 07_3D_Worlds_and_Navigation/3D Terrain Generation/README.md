...
![Python](https://img.shields.io/badge/Concept-3D%20Terrain%20Generation-purple)
![Python](https://img.shields.io/badge/Technique-Perlin%20Noise%20%26%203D-orange)
...
3. Open 3D_Terrain_Generation.py
4. Click Run ▶
5. Observe the animated 3D landscape evolving over time


### 📂 Project Structure
```
.
├── 3D_Terrain_Generation.py
├── README.md
├──3D_Terrain_Generation/
│	├──3D_Terrain_Generation.pyde
│	└──3D_Terrain_Generation.properties
└── assets/
	└── tgss.gif
```
