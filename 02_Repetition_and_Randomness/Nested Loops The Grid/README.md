...
![Python](https://img.shields.io/badge/Concept-Nested%20Loops-purple)
![Python](https://img.shields.io/badge/Technique-Grid%20Generation-orange)
...
3. Open Nested_Loops_The_Grid.py
4. Click Run ▶
5. Rerun to generate a new randomized grid


### 📂 Project Structure
```
.
├── Nested_Loops_The_Grid.py
├── README.md
├──Nested Loops/
│	├──Nested_Loops.pyde
│	└──Nested_Loops.properties
└── assets/
	└── nlss.png
```
